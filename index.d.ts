declare module "astronomy-svg" {
    export class AstronomySVG {
        ...
        drawCelestialBodyAltitudePath(celestialBody: string, width: number, isRectangular?: boolean, shouldDrawTime?: boolean): string;
        ...
        drawMoonPhase(width: number): string;

        drawCurrentTime(width: number): string;

        drawCurrentTimeWide(width: number): string;
