...
export function drawCelestialBodyAltitudePath(
  ...
  let northAzimuthToPoints = azimuthToPoints(0, maxWidth, azimuthReference);
  let southAzimuthToPoints = azimuthToPoints(180, maxWidth, azimuthReference);
  let azimuthIndicator =
    northAzimuthToPoints >= southAzimuthToPoints ? "N" : "S";
  let azimuthIndicatorPoints =
    northAzimuthToPoints >= southAzimuthToPoints
      ? northAzimuthToPoints
      : southAzimuthToPoints;
  ...
  svg += `
        ...
        <ellipse cx="${azimuthToPoints(sunAzimuth, maxWidth, azimuthReference)}" cy="${sunCenterY}" rx="${1.2 * maxWidth}" ry="125" fill="url(#twilight-glow-${sunAltitude})" clip-path="url(#bottom-half-clip)" />
        ...
        <g fill="white" font-size="60" font-family="Verdana" text-anchor="middle" dominant-baseline="middle">
            <text x="${azimuthIndicatorPoints}" y="550">${azimuthIndicator}</text>
        </g>
