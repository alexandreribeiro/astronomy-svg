...
export function drawSunAltitudePath(astronomyJS, widthInPixels, isRectangular) {
  ...
  svg += `
        ...
        <line x1="0" y1="500" x2="${maxWidth}" y2="500" stroke="${brightLineColor}" stroke-width="5" />
...
function brighterSkyGradientForAltitude(altitude) {
...
function inverseLinearInterpolation(smaller, bigger, value) {
